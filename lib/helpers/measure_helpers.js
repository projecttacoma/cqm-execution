...
module.exports = class MeasureHelpers {
  ...
  /**
     ...
     */
  static isSupplementalDataElementStatement(populationSets, statement) {
    for (var populationSet in populationSets){
      if(populationSet.supplemental_data_elements){
        const sde_statement = populationSet.supplemental_data_elements.find(sde => {sde.statement_name == statement.statement_name});
