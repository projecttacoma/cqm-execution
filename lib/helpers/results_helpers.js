...
module.exports = class ResultsHelpers {
  ...
  /*
    ...
    */
  static populationRelevanceForAllEpisodes(episodeResults, measureScoring, populationSet) {
    const masterRelevanceMap = {};
    for (const key in episodeResults) {
      const episodeResult = episodeResults[key];
      const popRelMap = this.buildPopulationRelevanceMap(episodeResult, measureScoring, populationSet);
  ...
  /**
     ...
     */
  static buildPopulationRelevanceMap(result, measureScoring, populationSet) {
