...
module.exports = class Calculator {
  ...
  static calculate(
    ...
    // default values for the passed in options object
    {
      ...
      requestDocument = false, // Always false in bonnie. Left for compatibility.
    } = {}
  ) {
    ...
    const populationSetsWithStratifcations =
      measure.allPopulationSetsAndStratifications;
