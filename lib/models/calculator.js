        ...
        if (populationResults) {
          ...
          if (episodeResults != null) {
            ...
            if (Object.keys(episodeResults).length > 0) {
               ...
               */
              populationRelevance = ResultsHelpers.populationRelevanceForAllEpisodes(episodeResults, measure.measure_scoring, populationSet);
            } else {
              // Use the patient based relevance if there are no episodes. This will properly set IPP or STRAT to true.
              populationRelevance = ResultsHelpers.buildPopulationRelevanceMap(populationResults, measure.measure_scoring, populationSet);
            }
          } else {
