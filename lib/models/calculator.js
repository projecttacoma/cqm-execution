...
const models = require("fhir-typescript-models/dist/src/models/cqm")
...
module.exports = class Calculator {
  ...
  static calculate(
    ...
    // default values for the passed in options object
    {
      ...
      timezoneOffset = 0,
      effectiveDate = null, // will default to measure.measure_period.start.value if not included
      effectiveDateEnd = null, // will default to measure.measure_period.end.value if this and effective_date not provided, if effective_date is provided will default to end of the effective_date year
    ...
    // TODO: implement cache on TS models
  ...
  static createPatientBundles(cqmPatients) {
    return cqmPatients.map(p => p.toBundle().toJSON());
  }
