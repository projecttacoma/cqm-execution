  ...
  static calculate(
    ...
    if (observations) {
      observations.forEach((obs) => {
        ...
        generatedELMJSON = (measure.calculation_method === 'PATIENT') ? CalculatorHelpers.generatePatientELMJSONFunction(funcName, parameter) : CalculatorHelpers.generateEpisodeELMJSONFunction(funcName, parameter);
