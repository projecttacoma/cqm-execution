...
var result_schema = require('../schemas/result_schema.js');
...
module.exports = class MongoDBResultSource {
  ...
  constructor(connectionInfo) {
    ...
    this.resultMongo = this.mongoose.model('Result', result_schema)
  ...
  save() {
    let result_mongo = this.resultMongo(this.embedded);
    result_mongo.save(function (err) {
