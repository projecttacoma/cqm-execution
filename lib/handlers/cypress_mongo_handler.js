...
module.exports = class Handler {
  ...
  /* Initialize connection to the MongoDB, and reinitialize relevant parameters */
  start(options) {
    mongoose.connect(this.connectionInfo);
    this.IndividualResult = mongoose.model('Individual_Result', IndividualResultSchema);
    this.individualResultsByMeasureId = {};
    this.aggregateResultsByMeasureId = {};
    if (options) {
  ...
  finish() {
    ...
    return {
      ...
      Aggregate: this.aggregateResultsByMeasureId,
    };
  }
