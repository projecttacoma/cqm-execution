...
module.exports = class Handler {
  ...
  handleResult(patient, result) {
    if (this.calculation_results[patient._id] == null) {
      this.calculation_results[patient._id] = {};
    }
    this.calculation_results[patient._id][result.embedded.measure_id] = result;
  }
